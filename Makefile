...
UE4Environment-Linux-Debug:
	 $(PROJECTBUILD) UE4Environment Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4Environment-Linux-DebugGame:
	 $(PROJECTBUILD) UE4Environment Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4Environment-Linux-Shipping:
	 $(PROJECTBUILD) UE4Environment Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4Environment-Linux-Test:
	 $(PROJECTBUILD) UE4Environment Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4Environment:
	 $(PROJECTBUILD) UE4Environment Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4EnvironmentEditor-Linux-Debug:
	 $(PROJECTBUILD) UE4EnvironmentEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4EnvironmentEditor-Linux-DebugGame:
	 $(PROJECTBUILD) UE4EnvironmentEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4EnvironmentEditor-Linux-Shipping:
	 $(PROJECTBUILD) UE4EnvironmentEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4EnvironmentEditor-Linux-Test:
	 $(PROJECTBUILD) UE4EnvironmentEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

UE4EnvironmentEditor:
	 $(PROJECTBUILD) UE4EnvironmentEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
