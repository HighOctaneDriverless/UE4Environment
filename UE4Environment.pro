...
unrealRootPath=/home/martin/UnrealEngine
UE4EnvironmentRootPath=/home/martin/Documents/Unreal Projects/UE4Environment

gameProjectFile=/home/martin/Documents/Unreal Projects/UE4Environment/UE4Environment.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(UE4EnvironmentSource.pri)
include(UE4EnvironmentHeader.pri)
include(UE4EnvironmentConfig.pri)
include(UE4EnvironmentIncludes.pri)
include(UE4EnvironmentDefines.pri)
...
UE4Environment-Linux-Debug.commands = $$build UE4Environment Linux Debug  -project="\"$$gameProjectFile\"" $$args
UE4Environment-Linux-DebugGame.commands = $$build UE4Environment Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
UE4Environment-Linux-Shipping.commands = $$build UE4Environment Linux Shipping  -project="\"$$gameProjectFile\"" $$args
UE4Environment-Linux-Test.commands = $$build UE4Environment Linux Test  -project="\"$$gameProjectFile\"" $$args
UE4Environment.commands = $$build UE4Environment Linux Development  -project="\"$$gameProjectFile\"" $$args

UE4EnvironmentEditor-Linux-Debug.commands = $$build UE4EnvironmentEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
UE4EnvironmentEditor-Linux-DebugGame.commands = $$build UE4EnvironmentEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
UE4EnvironmentEditor-Linux-Shipping.commands = $$build UE4EnvironmentEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
UE4EnvironmentEditor-Linux-Test.commands = $$build UE4EnvironmentEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
UE4EnvironmentEditor.commands = $$build UE4EnvironmentEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	UE4Environment-Linux-Debug \
	UE4Environment-Linux-DebugGame \
	UE4Environment-Linux-Shipping \
	UE4Environment-Linux-Test \
	UE4Environment \
	UE4EnvironmentEditor-Linux-Debug \
	UE4EnvironmentEditor-Linux-DebugGame \
	UE4EnvironmentEditor-Linux-Shipping \
	UE4EnvironmentEditor-Linux-Test \
	UE4EnvironmentEditor \
